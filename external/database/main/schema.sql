...
CREATE INDEX IF NOT EXISTS ind_agent_crypt ON agent USING BTREE (crypt);
...
CREATE INDEX IF NOT EXISTS ind_verify_moment ON verify USING BTREE (moment);
